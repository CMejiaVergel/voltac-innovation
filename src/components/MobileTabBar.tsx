...
const ICONS = {
  ...
  artefacto: "M12 3l8 4.5v9L12 21l-8-4.5v-9zM12 12l8-4.5M12 12v9M12 12L4 7.5",
  laminas: "M3 5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2zM8 21h8M12 17v4",
...
function projectTabs(slug: string): Tab[] {
  ...
  return [
    ...
    { href: `${base}/artefactos`, label: "Artefactos", icon: <Icon d={ICONS.artefacto} /> },
    { href: `${base}/presentacion`, label: "Láminas", icon: <Icon d={ICONS.laminas} /> },
...
const GLOBAL_TABS: Tab[] = [
  ...
  { href: "/cuenta", label: "Cuenta", icon: <Icon d={ICONS.user} /> },
];
